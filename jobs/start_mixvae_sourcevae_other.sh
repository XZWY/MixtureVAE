...
config_path="/data/romit/alan/MixtureVAE/config_MixtureVAE_SourceVAE_other.json"
# config_path="/ws/ifp-54_2/hasegawa/xulinf2/MixtureVAE/log_files/log_test_vae_kl_codec_100_256bn/config.json"
log_root="/data/romit/alan/MixtureVAE/log_files/log_mixvae_sourcevae_other"
...
echo "Train model...train_mixturevae.....single case"
