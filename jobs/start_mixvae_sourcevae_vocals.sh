...
config_path="/data/romit/alan/MixtureVAE/configs/config_MixtureVAE_SourceVAE_vocals.json"
# config_path="/ws/ifp-54_2/hasegawa/xulinf2/MixtureVAE/log_files/log_test_vae_kl_codec_100_256bn/config.json"
log_root="/data/romit/alan/MixtureVAE/log_files/log_mixvae_sourcevae_vocals"
...
echo "Train model...train_mixturevae..sourcevae...single case, vocals"
python3 ../train_mixture_source_vae_single.py \
