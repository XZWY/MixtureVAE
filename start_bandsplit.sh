...
config_path="/media/synrg/NVME-2TB/alanweiyang/MixVAE/config_SourceVAE_bandsplit.json"
# config_path="/ws/ifp-54_2/hasegawa/xulinf2/MixtureVAE/log_files/log_test_vae_kl_codec_100_256bn/config.json"
log_root="/media/synrg/NVME-2TB/alanweiyang/MixVAE/log_files/log_bandsplit"


echo "Train model..."
python3 train_source_vae_bandsplit.py \
    --musdb_root ${musdb_root_path}\
    --vocalset_root ${vocalset_root_path}\
    --config ${config_path} \
    --checkpoint_path ${log_root} \
