...
from models.SourceVAE_encodec import SourceVAE
...
def train(rank, a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            loss_gen_all = loss_gen_s + loss_gen_f + loss_gen_stft + loss_fm_s + loss_fm_f + loss_fm_stft + loss_mel + loss_kl + loss_snr
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    #            time.time() - start_b))
                    print(
                        'Steps : {:d}, Gen Loss Total : {:4.3f}, loss kl : {:4.3f}, Mel-Spec. Error : {:4.3f}, loss l1 : {:4.3f}, snr : {:4.3f}, s/b : {:4.3f}'.
                        format(steps, loss_gen_all.item(), loss_kl.item(), mel_error, loss_l1.item(), -loss_snr.item(), time.time() - start_b))
                # checkpointing
